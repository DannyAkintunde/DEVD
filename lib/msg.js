        ...
        if (m.msg) {
            ...
            if (m.quoted) {
                ...
                if (m.quoted.msg.conversation) {
                    quotedText = m.quoted.msg.conversation;
                } else if (m.quoted.msg.extendedTextMessage) {
                    quotedText = m.quoted.msg.extendedTextMessage.text;
                } else if (m.quoted.msg.imageMessage) {
                    quotedText = m.quoted.msg.imageMessage.caption;
                } else if (m.quoted.msg.videoMessage) {
                    quotedText = m.quoted.msg.videoMessage.caption;
                }
                m.quoted.quotedText = quotedText ? quotedText : null;
