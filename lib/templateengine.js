...
const FUNCTIONS = {
    ...
    quotestr: (value, symbol = "\"") => { if (isNaN(Number(value)) && !value.includes(symbol)) return symbol+value+symbol },
};
...
<<<<<<< HEAD
                        newData, quoted=false
=======
                        newData,
                        quoted = false
>>>>>>> 16d93c876740f68ae1864c5841837ca41c08254d
                    );
                });
            }
        }
