...
cmd(
    ...
    async (
        ...
        try {
            ...
            if (!isUrl(q)) return reply(imgmsg);
            let dat = `「 ${config.BOT} 」

   *📸 SCREENSHOT GETTER*`;
            const buttons = [
                {
                    buttonId: prefix + "ssdesktop " + q,
                    buttonText: { displayText: "DESKTOP" },
                    type: 1
                },
                {
                    buttonId: prefix + "ssphone " + q,
                    buttonText: { displayText: "MOBILE" },
                    type: 1
                },
                {
                    buttonId: prefix + "sstab " + q,
                    buttonText: { displayText: "TABLET" },
                    type: 1
                }
            ];
            const buttonMessage = {
...
cmd(
   ...
   *📸 SCREENSHOT GETTER*`;
            const buttons = [
                {
                    buttonId: prefix + "ssd " + name + ".jpg",
                    buttonText: { displayText: "DOCUMENT" },
                    type: 1
                },
                {
                    buttonId: prefix + "ssi " + name + ".jpg",
