                ...
                const sections = [
                    {
                        ...
                        rows: [
                            {
                                title: "1",
                                rowId: prefix + "selectaud " + q,
                                description: "SONG"
                            },
                            {
                                title: "2",
                                rowId: prefix + "selectvid " + q,
                                description: "VIDEO"
                            }
                        ]
                    }
                ...
                const sections = [
                    {
                        ...
                        rows: [
                            {
                                title: "1",
                                rowId: prefix + "ytdocs " + q,
                                description: "DOCUMENT SONG"
                            },
                            {
                                title: "2",
                                rowId: prefix + "ytmp3 " + q,
            ...
            const sections = [
                {
                    ...
                    rows: [
                        {
                            title: "1",
                            rowId: prefix + "selectaud " + anu.url,
                            description: "SONG"
                        },
                        {
                            title: "2",
                            rowId: prefix + "selectvid " + anu.url,
                            description: "VIDEO"
                        }
                    ]
                }
                        ...
                        rows: [
                            {
                                title: "1",
                                rowId: prefix + "240p " + q,
                                description: "240p Quality Video"
                            },
                            {
                                title: "2",
                                rowId: prefix + "360p " + q,
                                description: "360p Quality Video"
                            },
                            {
                                title: "3",
                                rowId: prefix + "480p " + q,
                                description: "480p Quality Video"
                            },
                            {
                                title: "4",
                                rowId: prefix + "720p " + q,
                                description: "720p Quality Video"
                            },
                            {
                                title: "5",
                                rowId: prefix + "1080p " + q,
                                description: "1080p Quality Video"
                            },
                            {
                                title: "6",
                                rowId: prefix + "1440p " + q,
                                description: "1440p Quality Video"
                            },
                            {
                                title: "7",
                                rowId: prefix + "2160p " + q,
                                description: "2160p Quality Video"
                            },
                            {
                                title: "8",
                                rowId: prefix + "ytdocv " + q,
            ...
            const sections = [
                {
                    ...
                    rows: [
                        {
                            title: "1",
                            rowId: prefix + "240p " + anu.url,
                            description: "240p Quality Video"
                        },
                        {
                            title: "2",
                            rowId: prefix + "360p " + anu.url,
                            description: "360p Quality Video"
                        },
                        {
                            title: "3",
                            rowId: prefix + "480p " + anu.url,
                            description: "480p Quality Video"
                        },
                        {
                            title: "4",
                            rowId: prefix + "720p " + anu.url,
                            description: "720p Quality Video"
                        },
                        {
                            title: "5",
                            rowId: prefix + "1080p " + anu.url,
                            description: "1080p Quality Video"
                        },
                        {
                            title: "6",
                            rowId: prefix + "1440p " + anu.url,
                            description: "1440p Quality Video"
                        },
                        {
                            title: "7",
                            rowId: prefix + "2160p " + anu.url,
                            description: "2160p Quality Video"
                        },
                        {
                            title: "8",
                            rowId: prefix + "ytdocv " + anu.url,
                            description: "Document type Video"
                        }
                    ]
                }
                        ...
                        rows: [
                            {
                                title: "1",
                                rowId: prefix + "ytdocs " + q,
                                description: "Down song document"
                            },
                            {
                                title: "2",
                                rowId: prefix + "ytmp3 " + q,
                                description: "Down song audio"
                            },
                            {
                                title: "3",
                                rowId: prefix + "ytinfo " + q,
                                description: "To see song info"
                            }
                        ]
                    }
                ];
    ...
    async (
        ...
        try {
            ...
            let senda = await conn.sendMessage(
                from,
                {
                    video: { url: await yt.video["240p"].download() },
    ...
    async (
        ...
        try {
            ...
            let senda = await conn.sendMessage(
                from,
                {
                    video: { url: await yt.video["360p"].download() },
                    caption: config.FOOTER
                },
                { quoted: mek }
            );
    ...
    async (
        ...
        try {
            ...
            let senda = await conn.sendMessage(
                from,
                {
                    video: { url: await yt.video["480p"].download() },
                    caption: config.FOOTER
                },
                { quoted: mek }
            );
    ...
    async (
        ...
        try {
            ...
            let senda = await conn.sendMessage(
                from,
                {
                    video: { url: await yt.video["720p"].download() },
                    caption: config.FOOTER
                },
                { quoted: mek }
            );
    ...
    async (
        ...
        try {
            ...
            let senda = await conn.sendMessage(
                from,
                {
                    video: { url: await yt.video["1080p"].download() },
                    caption: config.FOOTER
                },
                { quoted: mek }
            );
    ...
    async (
        ...
        try {
            ...
            let senda = await conn.sendMessage(
                from,
                {
                    video: { url: await yt.video["1440p"].download() },
                    caption: config.FOOTER
                },
                { quoted: mek }
            );
    ...
    async (
        ...
        try {
            ...
            let senda = await conn.sendMessage(
                from,
                {
                    video: { url: await yt.video["2160p"].download() },
                    caption: config.FOOTER
                },
                { quoted: mek }
            );
    ...
    async (
        ...
        try {
            ...
            if (fileSizeInMegabytes <= config.MAX_SIZE) {
                let sendaE = await conn.sendMessage(
                    from,
                    {
